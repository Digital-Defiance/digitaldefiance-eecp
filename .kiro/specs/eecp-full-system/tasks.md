...
- [x] 34. Final integration testing
...
- [x] 36. Write comprehensive README

- [x] 37. Update showcase
  - /showcase is copied from another project, update it, keeping Digital Defiance footer section.

- [x] 38. Implement browser-compatible server (stackblitz?) for showcase
  - [x] 38.1 Create BrowserEECPServer class
  ...
  - [x] 38.2 Create in-memory message bus
  ...
  - [x] 38.3 Update showcase to use browser server
  ...
  - [x] 38.4 Add visualization components
  ...
  - [x] 38.5 Write tests for browser server
