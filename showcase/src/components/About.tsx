    ...
    <section className="about section" id="about" ref={ref}>
      ...
      >
        ...
        <div className="about-content">
          ...
          >
            ...
            <p>
              ...
              developers to build secure, privacy-preserving applications that
              give users control over their data.
            </p>
            <p>
              We've built <strong>EECP</strong> to demonstrate that real-time
              collaboration doesn't require trusting servers with plaintext content.
              Through temporal encryption, zero-knowledge protocols, and cryptographic
              commitments, we provide provable guarantees that sensitive content
              becomes unreadable after expiration—no trust required.
            </p>
          ...
          <div className="about-features">
            ...
            >
              ...
              <h4>Cryptographic Guarantees</h4>
              <p>
                Property-based testing, temporal key rotation, and cryptographic
                commitments ensure the system behaves correctly.
              </p>
            </motion.div>
        ...
        >
          ...
          <p>
            Help us build the future of privacy-preserving collaboration.
        ...
        <div className="about-footer">
          ...
          <p className="footer-links">
            ...
            {" • "}
            <a
              href="https://www.npmjs.com/org/digitaldefiance-eecp"
              target="_blank"
              rel="noopener noreferrer"
            >
              NPM
