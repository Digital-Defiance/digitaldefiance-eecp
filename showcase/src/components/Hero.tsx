  ...
  return (
    <section className="hero" id="home">
      ...
      >
        ...
        >
          <span className="badge-text">🔐 Zero-Knowledge Ephemeral Collaboration</span>
        </motion.div>
        ...
        >
          ...
          <span className="hero-highlight">
            🔒 End-to-End Encrypted • ⏰ Temporal Keys • 🚫 Zero-Knowledge Server • 🤝 Real-Time CRDT • 🔑 ECIES Multi-Recipient
          </span>
        </motion.p>
